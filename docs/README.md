...
- [Launch readiness: OpenBot computers (BitMind as caller)](LAUNCH-READINESS-bitmind-openbot.md): draft findings only — OpenBot CEL / Chromium / supervisor and the BitMind door this repo exposes. BitMind itself is an external repo. Do not treat it as a feature or a deploy plan.
