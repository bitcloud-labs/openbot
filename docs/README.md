...
- [Launch readiness: BitMind + OpenBot](LAUNCH-READINESS-bitmind-openbot.md): draft findings only — how far until Bit Bot can launch with real agents and computers. Do not treat it as a feature or a deploy plan.
